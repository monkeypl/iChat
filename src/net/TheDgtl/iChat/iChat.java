...
public class iChat extends JavaPlugin {
	...
	public String parseChat(Player p, String msg, String chatFormat) {
		...
		String[] search = new String[] {"+suffix,+s", "+prefix,+p", "+group,+g", "+healthbar,+hb", "+health,+h", "+world,+w", "+time,+t", "+name,+n", "+displayname,+d", "+message,+m","+job"};
		String[] replace = new String[] { suffix, prefix, group, healthbar, health, world, time, p.getName(), p.getDisplayName(), msg, jobName };
